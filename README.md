...
- PDF text extraction + translation output saved as .txt
...
## How to Run
1. Open the `.ipynb` notebook in Jupyter Notebook
2. Run all cells from top to bottom
3. Use the provided functions to translate text/TXT/PDF inputs
